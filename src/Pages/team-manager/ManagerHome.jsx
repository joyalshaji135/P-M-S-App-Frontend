...
function ManagerHome() {
  return (
    <div className="flex-1 p-6 overflow-y-auto">
      <h1 className="text-2xl font-semibold text-gray-800 mb-4">Welcome, Team Manager!</h1>
      ...
      <div className="mt-6 bg-gradient-to-br from-yellow-50 via-green-50 to-teal-50 p-6 rounded-lg">
        ...
        <ul className="space-y-3">
          <li className="text-gray-800">Team member John Doe completed a task</li>
          <li className="text-gray-800">Event "Team Meeting" scheduled for Nov 20</li>
          <li className="text-gray-800">Google Meet with client ABC scheduled</li>
          <li className="text-gray-800">Recruitment message sent to 3 candidates</li>
        </ul>
      </div>
    </div>
  );
