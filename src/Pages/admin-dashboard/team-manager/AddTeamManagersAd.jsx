...
function AddTeamManager() {
  ...
  const addSkill = () => {
    setFormData(prev => ({
      ...
      skills: [
        ...prev.skills,
        { skillName: '', proficiency: 'beginner', yearsOfExperience: 0, certification: '' }
      ],
    }));
  };
    ...
    <div className="flex-1 p-6 overflow-y-auto bg-blue-50">
      ...
      >
        ...
        <p className="text-blue-600 mb-6">
          {id ? 'Update the team manager details' : 'Fill in the details to add a new team manager'}
        </p>
          ...
          <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-md">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-blue-800 mb-1">Preferences</label>
                  <div className="space-y-2 mt-2">
                    <label className="flex items-center">
                      ...
                      />
                      <span className="ml-2 text-sm text-blue-800">Newsletter</span>
                    </label>
                    <label className="flex items-center">
                      <input
                        type="checkbox"
                        ...
                        className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-blue-300 rounded"
                      />
                      <span className="ml-2 text-sm text-blue-800">Notifications</span>
                    </label>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              >
                ...
                <div className="space-y-4">
                  {['street', 'city', 'state', 'district', 'zipCode'].map((field) => (
                    <div key={field}>
            ...
            >
              ...
              {formData.skills.length === 0 ? (
                <p className="text-blue-600 text-center py-4">No skills added yet</p>
              ) : (
                <div className="space-y-4">
                  {formData.skills.map((skill, index) => (
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-blue-800 mb-1">Skill Name</label>
                          <input
                            type="text"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-blue-800 mb-1">Proficiency</label>
                          <select
                        ...
                        <div>
                          <label className="block text-sm font-medium text-blue-800 mb-1">Years of Experience</label>
                          <input
                            type="number"
                        ...
                        <div>
                          <label className="block text-sm font-medium text-blue-800 mb-1">Certification</label>
                          <input
                            type="text"
